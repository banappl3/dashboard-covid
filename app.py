...
control_panel = html.Div(
    ...
    children=[
        ...
        dcc.RadioItems(
            ...
            options=dropdown_options(['Confirmed', 'Active', 'Recovered', 'Deaths','Live']),
            value='Confirmed',
...
# This part appears when button is clicked
about_app = html.Div(
    children=[
        html.Ul([
            html.Li(
...
modal = html.Div(
    [
        ...
        dbc.Modal(
            [
                dbc.ModalHeader('COVID-19 Open Source Dashboard'),
                dbc.ModalBody(
                    children=[
                        # 
                        about_app,
